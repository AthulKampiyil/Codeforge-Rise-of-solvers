  ...
  <div style={{flex: '1', display: 'flex', gap: '16px', padding: '18px 22px', minHeight: '0'}}>
    ...
    <div className="panel" style={{flex: '1', minWidth: '0'}}>
      ...
      <div style={{flex: '1', position: 'relative', background: '#0b0f15', overflow: 'hidden'}}>
        <WarMapCanvas mapMode={mapMode} contestedOnly={contestedOnly} filteredGuild={filteredGuild} onZoneClick={setSelectedZone} />
        ...
        <div className="panel" style={{position: 'absolute', left: '16px', bottom: '16px', background: 'rgba(20,26,34,.97)'}}>
          <div className="panel-b" style={{padding: '11px 13px', gap: '7px'}}>
            ...
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: filteredGuild && filteredGuild !== 'Guild_Ironforge' ? 0.3 : 1}} onClick={() => setFilteredGuild(filteredGuild === 'Guild_Ironforge' ? null : 'Guild_Ironforge')}><span style={{width: '11px', height: '11px', border: '1.5px solid #c9a227', background: 'rgba(201,162,39,.15)', display: 'block'}}></span><span style={{fontSize: '11.5px'}}>Ironforge Union</span><span className="mono dim" style={{fontSize: '10.5px', marginLeft: 'auto'}}>2 zones</span></div>
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: filteredGuild && filteredGuild !== 'Guild_Nullbyte' ? 0.3 : 1}} onClick={() => setFilteredGuild(filteredGuild === 'Guild_Nullbyte' ? null : 'Guild_Nullbyte')}><span style={{width: '11px', height: '11px', border: '1.5px solid #4a90c9', background: 'rgba(74,144,201,.13)', display: 'block'}}></span><span style={{fontSize: '11.5px'}}>Nullbyte Syndicate</span><span className="mono dim" style={{fontSize: '10.5px', marginLeft: 'auto'}}>2 zones</span></div>
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: filteredGuild && filteredGuild !== 'Guild_Ironpeak' ? 0.3 : 1}} onClick={() => setFilteredGuild(filteredGuild === 'Guild_Ironpeak' ? null : 'Guild_Ironpeak')}><span style={{width: '11px', height: '11px', border: '1.5px solid #c94a4a', background: 'rgba(201,74,74,.13)', display: 'block'}}></span><span style={{fontSize: '11.5px'}}>Ironpeak Circle</span><span className="mono dim" style={{fontSize: '10.5px', marginLeft: 'auto'}}>2 zones</span></div>
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: filteredGuild && filteredGuild !== 'Guild_Verdant' ? 0.3 : 1}} onClick={() => setFilteredGuild(filteredGuild === 'Guild_Verdant' ? null : 'Guild_Verdant')}><span style={{width: '11px', height: '11px', border: '1.5px solid #4ac97f', background: 'rgba(74,201,127,.11)', display: 'block'}}></span><span style={{fontSize: '11.5px'}}>Verdant Order</span><span className="mono dim" style={{fontSize: '10.5px', marginLeft: 'auto'}}>1 zone</span></div>
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', opacity: filteredGuild && filteredGuild !== 'unclaimed' ? 0.3 : 1}} onClick={() => setFilteredGuild(filteredGuild === 'unclaimed' ? null : 'unclaimed')}><span style={{width: '11px', height: '11px', border: '1.5px solid #5c6673', display: 'block'}}></span><span className="muted" style={{fontSize: '11.5px'}}>Unclaimed</span><span className="mono dim" style={{fontSize: '10.5px', marginLeft: 'auto'}}>1 zone</span></div>
            <div style={{cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', paddingTop: '4px', borderTop: '1px solid #2a323d', opacity: contestedOnly ? 1 : 0.6}} onClick={() => setContestedOnly(!contestedOnly)}><span style={{width: '11px', height: '11px', border: '1.5px dashed #8b96a5', display: 'block'}}></span><span className="muted" style={{fontSize: '11.5px'}}>Contested (within 20%)</span></div>
          </div>
        </div>
      </div>
    </div>
